...
@referers = ('www.north-muskoka.com','sympatico.ca');

# @recipients defines the e-mail addresses or domain names that e-mail can   #
# be sent to.  This must be filled in correctly to prevent SPAM and allow    #
# valid addresses to receive e-mail.  Read the documentation to find out how #
# this variable works!!!  It is EXTREMELY IMPORTANT.                         #
@recipients = ('^nmuskoka@hotmail.com');
...
sub return_html {
    ...
    # Otherwise, begin printing the response page.                           #
        ...
        else { print "   <h1>Thank You For Submitting your North-Muskoka Membership Listing info.</h1>\n" }

        print "</center>\n";

        print "Below is the contents of what you submitted. $Config{'recipient'} ";
        print "<br>on $date<p>If you checked off Full Listing,  we will be in touch with you shortly to obtain payment info.";
print "Click <a href=\"http://www.north-muskoka.com\" target=\"_blank\">here</a> to return to Home Page<hr size=1 width=75\%><p> \n";
...
#BSS
    ...
    print MAIL "North Muskoka Advertising feedback form:\n";
    print MAIL "    Submitted by: $Config{'realname'} ($Config{'email'})\n    on $date\n";
